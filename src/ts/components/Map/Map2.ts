...
export class Map2 extends Component {
    ...
    private addMarkers = (): void => {
        ...
        this.map.addSource(Map2.SOURCE_NAME, geojson);
    ...
    private updateMarkers(): void {
        const newMarkers = {};
        const features = this.map.querySourceFeatures(Map2.SOURCE_NAME);
    ...
    private onMarkerClick = (marker: HTMLElement): void => {
        ...
        if (markerId) {
            ...
            (this.map.getSource(Map2.SOURCE_NAME) as mapboxgl.GeoJSONSource).getClusterLeaves(parseInt(clusterId, 10), 10, 0, (error, features) => {
