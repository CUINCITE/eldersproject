...
$cfg=array(
		...
		[
			...
			'serdelia_cache_kill_plugin'      =>  'cache',                 //  set cache folder of your website, so after any change in the CMS this folder will be cleared by the CMS (all files will be removed!)
